...
from data import load_df, TransformersTokenDataset, LOSS_IGNORE_INDEX, ID2TAG, TAG2ID, \
	TransformersTokenDatasetWithFrames
...
if __name__ == "__main__":
	...
	controller = MetaphorMultiTaskController.load(args.model_dir,
												  batch_size=pred_args["batch_size"],
												  device=("cpu" if pred_args["use_cpu"] else "cuda"))
	test_dataset = TransformersTokenDatasetWithFrames.from_dataframe(
		...
		frame_encoding=controller.frame2id
	)
